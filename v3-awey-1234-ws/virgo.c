...
static void virgo_toggle_hotkeys(Virgo *v)
{
	...
	if (v->handle_hotkeys) {
	register_hotkey(0, MOD_ALT | MOD_NOREPEAT, '1');
	register_hotkey(1, MOD_ALT | MOD_SHIFT | MOD_NOREPEAT, '1');
	register_hotkey(2, MOD_ALT | MOD_NOREPEAT, '2');
	register_hotkey(3, MOD_ALT | MOD_SHIFT | MOD_NOREPEAT, '2');
	register_hotkey(4, MOD_ALT | MOD_NOREPEAT, '3');
	register_hotkey(5, MOD_ALT | MOD_SHIFT | MOD_NOREPEAT, '3');
	register_hotkey(6, MOD_ALT | MOD_NOREPEAT, '4');
	register_hotkey(7, MOD_ALT | MOD_SHIFT | MOD_NOREPEAT, '4');
	} else {
		for (i = 0; i < NUM_DESKTOPS; i++) {
...
static void virgo_init(Virgo *v)
{
	...
	register_hotkey(8, MOD_ALT | MOD_SHIFT | MOD_NOREPEAT, '0');
	register_hotkey(9, MOD_ALT | MOD_SHIFT | MOD_NOREPEAT, '9');
